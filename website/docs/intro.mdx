...
from the version picker, top-right](pathname:///)). Human-in-the-Loop
([guide →](./guides/hitl/overview)) — `HitlChannel`, `CheckpointedChannel`,
`ask_user`, `ConfirmToolCallMiddleware` — landed in 0.6. The native
