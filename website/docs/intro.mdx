...
version picker, top-right](pathname:///)). CubePi 0.12 adds
`tool_result_compressor` for selective tool result preservation during
compaction, sender attribution at the provider boundary, and deferred
tool ordering hints for smoother streaming UX.
