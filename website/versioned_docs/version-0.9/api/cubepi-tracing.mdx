...
[source](https://github.com/cubeplexai/cubepi/blob/main/cubepi/tracing/meter.py#L199)
...
[source](https://github.com/cubeplexai/cubepi/blob/main/cubepi/tracing/meter.py#L209)
...
```python
oneshot(*, model: 'BoundModel', operation: str = 'oneshot', metadata: 'dict[str, str | int | float | bool] | None' = None, record_content: bool | None = None) -> AsyncIterator['_OneShotSession']
```
