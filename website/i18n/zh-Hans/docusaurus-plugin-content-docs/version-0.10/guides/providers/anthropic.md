...
```python
AnthropicProvider(provider_id="anthropic", api_key=…, cache_retention="long")  # 1 小时 TTL
AnthropicProvider(provider_id="anthropic", api_key=…, cache_retention="none")  # 完全禁用
```
