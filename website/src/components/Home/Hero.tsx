...
export default function Hero() {
  const social = useBaseUrl('/img/brand/cubeloop-social-preview.png');
  const installCmd = 'pip install cubeloop';
  ...
  return (
    <section className={styles.hero}>
      <img
        ...
        src={social}
        alt="CubeLoop · A Pythonic, async-native agent framework"
        width={1280}
        height={640}
        fetchPriority="high"
      />
      <div className={styles.eyebrow}>cubeloop · v{version}</div>
      ...
      <p className={styles.lead}>
        {zh ? (
          <>
            CubeLoop 是一个 Pythonic 原生异步 Agent 框架，专为高性能、高可读性和生产级持久化而设计。
      ...
      <p className={styles.lead}>
        {zh ? (
          <>
            ...
            {' '}
            基于 CubeLoop 构建，是面向团队工作区的云原生托管 Agent 平台——技能、共享记忆、MCP 工具、
