---
name: cubeloop
description: Use when building, extending, or debugging agents with the CubeLoop framework. Covers the Agent API, providers, tools, middleware, checkpointing, MCP integration, and HITL. References the cubeloop-trace skill for run debugging.
---

# Building agents with CubeLoop

CubeLoop is a Pythonic, async-native agent framework. The agent loop is a plain
`while` loop — no graph nodes, no state machines. You can read the full runtime
in a few minutes.

**Docs:** https://cubeloop.dev/docs  
**Source:** https://github.com/cubeplexai/cubeloop  
**Issues / PRs:** https://github.com/cubeplexai/cubeloop/issues
...
```bash
pip install cubeloop                              # core
pip install cubeloop[mcp]                        # MCP tool loaders
pip install cubeloop[tracing,trace-cli]          # OpenTelemetry + cubeloop trace CLI
...
```python
from cubeloop import Agent, AgentTool, Model
...
Full tool docs: https://cubeloop.dev/docs/guides/tools
...
https://cubeloop.dev/docs/guides/streaming
...
Full docs: https://cubeloop.dev/docs/guides/middleware
...
Full docs: https://cubeloop.dev/docs/guides/checkpointing

### MCP tools

```python
from cubeloop.mcp import MCPToolLoader
...
Full docs: https://cubeloop.dev/docs/guides/mcp
...
Full docs: https://cubeloop.dev/docs/guides/hitl

## Debugging runs

Install the `cubeloop-trace` skill — it gives you the full protocol for
...
The skill covers `cubeloop trace ls / view / follow / stats / convert`, token
and cache-rate conventions, and streaming failure debugging.

## Getting help

- **Docs:** https://cubeloop.dev/docs  
- **Source:** https://github.com/cubeplexai/cubeloop (read it — it's short)  
- **Issues:** https://github.com/cubeplexai/cubeloop/issues  
