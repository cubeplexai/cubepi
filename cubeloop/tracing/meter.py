"""``Meter`` — OTel histograms for cubeloop.tracing.

Mirrors :class:`cubeloop.tracing.tracer.Tracer` in shape: construct once,
...
class Meter:
    ...
    def attach(self, agent: "Agent") -> Callable[[], None]:
        ...
        """
        from cubeloop.providers.base import BaseProvider, collect_agent_providers
