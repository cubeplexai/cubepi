"""argparse wiring for `cubeloop trace`."""
...
from cubeloop.cli.trace import loader, render, stats
from cubeloop.cli.trace.follow import follow_run
from cubeloop.cli.trace.model import build_forest


def register(subparsers: "argparse._SubParsersAction") -> None:
    trace = subparsers.add_parser("trace", help="inspect cubeloop JSONL traces")
    ...
    from cubeloop.cli.trace.convert import cmd_convert
...
def _add_dir(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        ...
        help="traces directory (default: ./cubeloop-traces)",
    )
